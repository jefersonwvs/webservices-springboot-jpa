...
public class Order implements Serializable {
	...
	@JoinColumn(name = "client_id") /* adicão de um coluna */
	private User client;
	
	@OneToMany(mappedBy = "id.order")
	private Set<OrderItem> items = new HashSet<>();
	
	@OneToOne(mappedBy = "order", 			/* Mapeamento 1:1 - entidade independente */
			  cascade = CascadeType.ALL) 	/* Faz com o id de payment seja o mesmo do seu respectivo order */
