...
import com.example.demo.respositories.OrderItemRepository;
import com.example.demo.respositories.OrderRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		orderRepository.save(o1); // para salvar o pagamento, como ele é o objeto dependente, deve-se chamar o repositório do objeto do qual ele depende
	}
